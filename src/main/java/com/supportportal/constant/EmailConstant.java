...
public class EmailConstant {
	 ...
	 public static final String USERNAME = "fray.khalil.200@gmail.com";
	 public static final String PASSWORD = "abkgokxfbazhnznf";
	 
	 public static final String FROM_EMAIL = "support@getarrays.com";
	 public static final String CC_EMAIL ="";
	 public static final String EMAIL_SUBJECT = "Lumiere , LLC - New Password";
